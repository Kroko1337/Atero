...
public class GlyphPageFontRenderer {
    ...
    public static GlyphPageFontRenderer create(String fontName, int size, boolean bold, boolean italic, boolean boldItalic, boolean fractionalMetrics) {
        ...
        try {
            regularPage = new GlyphPage(getFontByName(fontName).deriveFont((float) size), true, fractionalMetrics);
    ...
    private static Font getFontByName(String name) throws IOException, FontFormatException {
        return getFontFromInput("/assets/minecraft/atero/fonts/" + name + ".ttf");
    }
