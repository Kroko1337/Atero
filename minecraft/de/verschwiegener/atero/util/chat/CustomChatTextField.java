...
public class CustomChatTextField extends GuiTextField {
    ...
    public CustomChatTextField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height) {
