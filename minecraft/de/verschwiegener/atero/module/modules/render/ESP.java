...
public class ESP extends Module {
    ...
    {
        double x =
                blockPos.getX() - Minecraft.getMinecraft().getRenderManager().renderPosX +5;
        double y =
                blockPos.getY() - Minecraft.getMinecraft().getRenderManager().renderPosY - 0.125;
        double z =
                blockPos.getZ() - Minecraft.getMinecraft().getRenderManager().renderPosZ +5;
