...
public class CustomGuiButton extends GuiButton {
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY) {
		if (this.visible) {
			...
			this.drawTexturedModalRect(this.xPosition, this.yPosition, 0, 46 + i * 20,
			...
			Management.instance.fontrenderer.drawString(this.displayString,(this.xPosition * 2) + Management.instance.fontrenderer.getStringWidth2(this.displayString),(this.yPosition) * 2 + (Management.instance.fontrenderer.getBaseStringHeight() / 2), j);
			// this.drawCenteredString(fontrenderer, this.displayString, this.xPosition + this.width / 2, this.xPosition + this.width / 2, j);
		}
	}
