...
public class CustomGUIIngame {
    ...
    public static void drawArrayList() {
        ...
        for (int i = 0; i < Management.instance.modulemgr.modules.size(); i++) {
            if (Management.instance.modulemgr.modules.get(i).isEnabled()) {
                ...
                yoffset += FontManager.ROBOTOTHIN_20.getFontHeight() + 4;
    ...
    public static void renderRadar(int mouseX, int mouseY) {
        ...
        RenderUtil.drawRect(posX + halfWidth, posY + halfHeight, posX + halfWidth + 1, posY + halfHeight + 1, new Color(205, 205, 205, 255).getRGB());
      ...
      //  EntityLivingBase target = Killaura.instance.getTarget();
       ...
       // if (target != null && target instanceof EntityPlayer || target instanceof EntityAnimal || target instanceof EntityVillager || target instanceof EntityMob && Management.instance.modulemgr.getModuleByName("Killaura").isEnabled()) {
        ...
        //    float healthProcent = target.getHealth() / target.getMaxHealth();
         //   RenderUtil.drawRect(55, 15, 55 + (90 * healthProcent), 25, Color.HSBtoRGB(Math.min(-healthProcent + 0.3F, 0), 1, 1));
...
//
          ...
          //  font.drawString(message, 50.5F - font.getStringWidth(message) + font.getStringWidth(message) / 1F, 30F,
	...
	//drawImage((int) (xP -10), (int) (yP + fontRenderer.getStringHeight("") -10), widthP - 20, heightP + 40,
        ...
        if (target instanceof EntityPlayer) {
            ...
            while (itarlor.hasNext()) {
                ...
                if (mc.theWorld.getPlayerEntityByUUID(networkPlayerInfo.getGameProfile().getId()) == target) {
                    ...
                    Gui.drawScaledCustomSizeModalRect(s.getScaledWidth() / 2 +10, s.getScaledHeight() / 2 -22, 8.0F, 8.0F, 8, 8, 28, 28, 64.0F, 66.0F);
