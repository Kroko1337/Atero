...
public class GuiPlayerTabOverlay extends Gui {
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn) {
        ...
        for (NetworkPlayerInfo networkplayerinfo : list) {
            String prefix = this.getIrcPrefix(this.getPlayerName(networkplayerinfo),
                    networkplayerinfo.getGameProfile());

            int k = this.mc.fontRendererObj.getStringWidth(prefix + this.getPlayerName(networkplayerinfo));
            i = Math.max(i, k);
        ...
        for (int k4 = 0; k4 < l3; ++k4) {
            ...
            if (k4 < list.size()) {
                ...
                s1 = getIrcPrefix(s1, gameprofile) + s1;
